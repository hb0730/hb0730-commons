...
public class MapBuilderTest {
    ...
    public void testBuildTest() {
        MapBuilder<String, String> map = MapBuilder.build(25);
        Assert.assertNotNull("创建失败，map为空", map);
    }

    @Test
    public void testBuild1Test() {
        MapBuilder<String, String> map = MapBuilder.build(MapUtils.newHashMap());
        Assert.assertNotNull("创建失败，map为空", map);
    }
    ...
    public void builderTest() {
        ...
        Map<String, String> builder = map.builder();
